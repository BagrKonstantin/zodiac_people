...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_sex.setGeometry(QtCore.QRect(410, 350, 241, 45))
        font = QtGui.QFont()
        ...
        self.label_fio.setGeometry(QtCore.QRect(40, 10, 731, 45))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.label_9.setGeometry(QtCore.QRect(40, 360, 131, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(20)
        font.setBold(True)
