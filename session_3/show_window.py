...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_sex.setGeometry(QtCore.QRect(410, 350, 201, 41))
        font = QtGui.QFont()
        ...
        self.label_fio.setGeometry(QtCore.QRect(40, 0, 731, 51))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(20)
        font.setBold(True)
...
"}")
        ...
        self.label_age.setGeometry(QtCore.QRect(410, 50, 241, 51))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(20)
        font.setBold(True)
